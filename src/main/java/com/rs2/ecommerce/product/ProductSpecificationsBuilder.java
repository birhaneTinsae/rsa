...
import com.rs2.ecommerce.utils.SearchCriteria;
import com.rs2.ecommerce.utils.SearchOperation;
...
public class ProductSpecificationsBuilder {
    ...
    public final ProductSpecificationsBuilder with(SearchCriteria criteria) {
        params.add(criteria);
        return this;
    }
}
